-- ==========================================
-- 1. LISAME MANUAALSE VIIGIMURDJA VEERU
-- ==========================================
ALTER TABLE public.group_teams ADD COLUMN IF NOT EXISTS manual_tiebreaker INTEGER DEFAULT 0;

-- ==========================================
-- 2. LISAME/UUENDAME TABELISEISU VAATE (VIEW)
-- ==========================================
...
WITH team_stats AS (
    ...
    GROUP BY 
        gt.group_id, gt.team_id, gt.manual_tiebreaker
)
SELECT 
    ts.group_id,
    ts.team_id,
    ts.manual_tiebreaker,
    ts.played,
    ts.won,
    ts.drawn,
    ts.lost,
